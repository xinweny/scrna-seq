...
setwd("/rds/project/rs2099/rds-rs2099-toxgenomics/scrna-seq")

# Path to cds containing all the data
path_to_cds = "./data/GSE139944/sciPlex3/GSM4150378_sciPlex3_cds_all_cells.RDS"
...
coldata_rts = read.table("./data/GSE139944/sciPlex3/drug_rt_indices.tsv", header = F)
...
rowdata_genes =
  read.table(
    file = "./data/GSE139944/sciPlex3/gencode.v27.transcripts.bed",
    header = F,
    sep = "\t",
    col.names = c(
      "chromosome",
...
joint_matrix_aggregated %>%
  ...
  ggsave(
    "./data/GSE139944/processed/sciPlex3_vehicle_correlation_per_gene_counts_prot.png",
    width = 2.25,
    height = 1.5,
    dpi = 300
  )
...
write.table(
  deseq_res,
  "./data/GSE139944/processed/sciPlex3_deseq_res.txt",
  row.names = F,
  quote = F,
  sep = "\t"
)
...
A549_test_res = read.table("./data/GSE139944/sciPlex3/Supplementary_Table_5_A549.txt",
                           header = T)
...
K562_test_res = read.table("./data/GSE139944/sciPlex3/Supplementary_Table_5_K562.txt",
                           header = T)
...
drug_annotations = read.table("./data/GSE139944/sciPlex3/drugProperties_short.tsv",
                              header = T,
                              sep = "\t")
...
pathway_annotations = read.table("./data/GSE139944/sciPlex3/Supplementary_Table_3.txt",
                                 header = T,
                                 sep = "\t")
...
ggplot(
  ...
  ggsave(
    "supplemental_figure9_correlations_effect_sizes.pdf",
    height = 2,
    width = 6
  )
